			...
			<div className="project_introduction project_wrapper--large">
				<h1 className="project_introduction__content">
					...
					<span
						...
						className="project_introduction__content-el project_introduction__content-el--description">
						{title}
					</span>
					<span
						data-aos="fade-left"
						...
						className="project_introduction__content-el project_introduction__content-el--job">
						{subtitle}
					</span>
				</h1>
				<div
